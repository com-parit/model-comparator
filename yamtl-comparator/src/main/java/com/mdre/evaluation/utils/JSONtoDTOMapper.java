...
public class JSONtoDTOMapper {
	public static ModelComparisonConfigurationDTO mapToModelComparisonConfigurationDTO(JSONObject jsonObject) {
		...
		HashingConfigurationDTO hashingConfigurationDTO = new HashingConfigurationDTO();
		...
		try {
			hashingConfigurationDTO.INCLUDE_CLASS_PARAMETERS = jsonObject.getBoolean("INCLUDE_CLASS_PARAMETERS");
		} catch (Exception e) {
