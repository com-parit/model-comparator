...
def test_ecore_to_emfatic_conversion():
    ...
    try:
        emfatic_path = Adapter_Ftests.get_emfatic_from_ecore("test_data/sample_ecore_model_base.ecore")
        print("Passed")
...
def test_emfatic_to_ecore_conversion():
    ...
    try:
        ecore_path = Adapter_Ftests.get_ecore_model_from_emfatic("test_data/sample_ecore_model_base.emf")
        print("Passed")
    except Exception as e:
        print("Failed")
...
def test_uml2_to_ecore_conversion():
    ...
    try:
        ecore_path = Adapter_Ftests.get_ecore_model_from_uml2("test_data/sample_uml_model_base.uml")
        print("Passed")
    except Exception as e:
        print("Failed")
