...
user_choice = st.selectbox("What do you want to do?", ["Choose", "Compare Ecore", "Compare Emfatic", "Compare UML2", "Bulk Comparison", "Ecore to Emfatic", "Emfatic to Ecore", "Uml2 to Ecore"])
